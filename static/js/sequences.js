...
//        d3.select("#toggleanswer").on("click", showans);
    ...
    function mouseleaveclick(d) {
        var ques = temp.value
        var totalp = (100 * temp.value / 503865).toPrecision(3);
        var percentage = (100 * temp.value / totalSize).toPrecision(3);
        var percentageString = percentage + "%";
        if (percentage < 0.1) {
            percentageString = "< 0.1%";
        }
        var totalpstring = "/503865 = " + totalp + "%";
    ...
    function click(d)
    {
        ...
        d3.select("#chart-container").selectAll("path").remove();
        ...
        // Add the mouseleave handler to the bounding circle.
        d3.select("#chart-container").on("mouseleave", mouseleaveclick);
